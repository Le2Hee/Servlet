...
public class FirstServlet extends HttpServlet {
    // src/main/webapp/WEB-INF/web.xml 파일에서 요청 주소 매핑이 되어 있음.
    // http:localhost:8081/jsp1/ex1 요청에 매핑된 서블릿 클래스.
    // web.xml: 서버가 사용하는 환경설정 파일이다.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
	    ...
	    // 파라미터 response : WAS가 클라이언트로 보낼 응답을 작성하기 위해 필요한 기능들을 
	    //                     가지고 있는 객체.
	    ...
	    PrintWriter writer = response.getWriter(); // 응답을 하기 위한 객체.
